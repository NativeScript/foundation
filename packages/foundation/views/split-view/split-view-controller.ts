...
@NativeClass
export class SplitViewController extends NSSplitViewController implements NSSplitViewDelegate {
  static ObjCProtocols = [NSSplitViewDelegate, NSViewControllerPresentationAnimator];
  ...
  animateDismissalOfViewControllerFromViewController(viewController: NSViewController, _fromViewController: NSViewController): void {
