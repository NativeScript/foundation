...
@NativeClass
export class NativeTextFieldDelegate extends NSObject implements NSTextFieldDelegate {
...
export class TextField extends Text {
  ...
  public initNativeView(): NSTextField {
    ...
    nativeView.delegate = NativeTextFieldDelegate.initWithOwner(new WeakRef(this));
