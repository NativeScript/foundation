...
export class NSScrollViewAutoResizable extends NSScrollView {
  ...
  initScrollEvents(owner: ScrollView) {
    ...
    NSNotificationCenter.defaultCenter.addObserverSelectorNameObject(this, 'boundsDidChange', NSViewBoundsDidChangeNotification, this?.contentView);
  }

  deinitScrollEvents() {
    NSNotificationCenter.defaultCenter.removeObserverNameObject(this, NSViewBoundsDidChangeNotification, this?.contentView);
  }
...
export class ScrollView extends View {
  ...
  removeChild<T extends Node>(child: T): T {
    if ((child as Node) === this.documentView || !this.documentView || this._disableDefaultDocumentView) {
