...
export class Color {
  ...
  private parseColorName(name: string) {
    ...
    let idx;
    if ((idx = colorNames.findIndex((c) => c.toLowerCase() === name.toLowerCase())) !== -1) {
  ...
  public toNSColor() {
    return this.transparent ? NSColor.clearColor : NSColor.colorWithSRGBRedGreenBlueAlpha(this.red, this.green, this.blue, this.alpha);
  }
