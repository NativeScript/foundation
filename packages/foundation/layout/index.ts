...
const ConvertToYogaValue = {
  ...
  borderBottomWidth: (value: FlexStyle['borderBottomWidth']): number | undefined => value,
  borderEndWidth: (value: FlexStyle['borderEndWidth']): number | undefined => value,
  borderLeftWidth: (value: FlexStyle['borderLeftWidth']): number | undefined => value,
  borderRightWidth: (value: FlexStyle['borderRightWidth']): number | undefined => value,
  borderStartWidth: (value: FlexStyle['borderStartWidth']): number | undefined => value,
  borderTopWidth: (value: FlexStyle['borderTopWidth']): number | undefined => value,
  ...
  flexBasis: (value: FlexStyle['flexBasis']): DimensionValue | undefined => value,

  flexDirection: (value: FlexStyle['flexDirection']): FlexDirection | undefined => {
    switch (value) {
      case 'row':
  ...
  marginBlock: (value: FlexStyle['marginBlock']): DimensionValue | undefined => value,
  marginBlockEnd: (value: FlexStyle['marginBlockEnd']): DimensionValue | undefined => value,
  marginBlockStart: (value: FlexStyle['marginBlockStart']): DimensionValue | undefined => value,
  marginBottom: (value: FlexStyle['marginBottom']): DimensionValue | undefined => value,
  marginEnd: (value: FlexStyle['marginEnd']): DimensionValue | undefined => value,
  marginHorizontal: (value: FlexStyle['marginHorizontal']): DimensionValue | undefined => value,
  marginInline: (value: FlexStyle['marginInline']): DimensionValue | undefined => value,
  marginInlineEnd: (value: FlexStyle['marginInlineEnd']): DimensionValue | undefined => value,
  marginInlineStart: (value: FlexStyle['marginInlineStart']): DimensionValue | undefined => value,
  marginLeft: (value: FlexStyle['marginLeft']): DimensionValue | undefined => value,
  marginRight: (value: FlexStyle['marginRight']): DimensionValue | undefined => value,
  marginStart: (value: FlexStyle['marginStart']): DimensionValue | undefined => value,
  marginTop: (value: FlexStyle['marginTop']): DimensionValue | undefined => value,
  marginVertical: (value: FlexStyle['marginVertical']): DimensionValue | undefined => value,

  maxHeight: (value: FlexStyle['maxHeight']): DimensionValue | undefined => value,
  maxWidth: (value: FlexStyle['maxWidth']): DimensionValue | undefined => value,
  minHeight: (value: FlexStyle['minHeight']): DimensionValue | undefined => value,
  ...
  paddingBottom: (value: FlexStyle['paddingBottom']): DimensionValue | undefined => value,
  paddingBlock: (value: FlexStyle['paddingBlock']): DimensionValue | undefined => value,
  paddingBlockEnd: (value: FlexStyle['paddingBlockEnd']): DimensionValue | undefined => value,
  paddingBlockStart: (value: FlexStyle['paddingBlockStart']): DimensionValue | undefined => value,
  paddingEnd: (value: FlexStyle['paddingEnd']): DimensionValue | undefined => value,
  paddingHorizontal: (value: FlexStyle['paddingHorizontal']): DimensionValue | undefined => value,
  paddingInline: (value: FlexStyle['paddingInline']): DimensionValue | undefined => value,
  paddingInlineEnd: (value: FlexStyle['paddingInlineEnd']): DimensionValue | undefined => value,
  paddingInlineStart: (value: FlexStyle['paddingInlineStart']): DimensionValue | undefined => value,
  paddingLeft: (value: FlexStyle['paddingLeft']): DimensionValue | undefined => value,
  paddingRight: (value: FlexStyle['paddingRight']): DimensionValue | undefined => value,
  paddingStart: (value: FlexStyle['paddingStart']): DimensionValue | undefined => value,
  paddingTop: (value: FlexStyle['paddingTop']): DimensionValue | undefined => value,
  paddingVertical: (value: FlexStyle['paddingVertical']): DimensionValue | undefined => value,
...
const ConvertFromYogaValue = {
  ...
  marginBlockStart: (value: DimensionValue): FlexStyle['marginBlockStart'] => value,
  marginBottom: (value: DimensionValue): FlexStyle['marginBottom'] => value,
  marginEnd: (value: DimensionValue): FlexStyle['marginEnd'] => value,
  marginHorizontal: (value: DimensionValue): FlexStyle['marginHorizontal'] => value,
  marginInline: (value: DimensionValue): FlexStyle['marginInline'] => value,
  marginInlineEnd: (value: DimensionValue): FlexStyle['marginInlineEnd'] => value,
  marginInlineStart: (value: DimensionValue): FlexStyle['marginInlineStart'] => value,
  ...
  paddingBlockEnd: (value: DimensionValue): FlexStyle['paddingBlockEnd'] => value,
  paddingBlockStart: (value: DimensionValue): FlexStyle['paddingBlockStart'] => value,
  paddingEnd: (value: DimensionValue): FlexStyle['paddingEnd'] => value,
  paddingHorizontal: (value: DimensionValue): FlexStyle['paddingHorizontal'] => value,
  paddingInline: (value: DimensionValue): FlexStyle['paddingInline'] => value,
  paddingInlineEnd: (value: DimensionValue): FlexStyle['paddingInlineEnd'] => value,
  paddingInlineStart: (value: DimensionValue): FlexStyle['paddingInlineStart'] => value,
  ...
  paddingVertical: (value: DimensionValue): FlexStyle['paddingVertical'] => value,
...
const Setters = {
  ...
  flexBasis(yogaNode: YogaNode, flexBasis: number | 'auto' | `${number}%` | undefined) {
  ...
  width(yogaNode: YogaNode, height: number | 'auto' | `${number}%` | undefined) {
    yogaNode.setWidth(height);
  },
  height(yogaNode: YogaNode, height: number | 'auto' | `${number}%` | undefined) {
  ...
  marginLeft(yogaNode: YogaNode, margin: number | 'auto' | `${number}%` | undefined) {
    yogaNode.setMargin(Edge.Left, margin);
  },
  marginRight(yogaNode: YogaNode, margin: number | 'auto' | `${number}%` | undefined) {
    yogaNode.setMargin(Edge.Right, margin);
  },
  marginTop(yogaNode: YogaNode, margin: number | 'auto' | `${number}%` | undefined) {
    yogaNode.setMargin(Edge.Top, margin);
  },
  marginBottom(yogaNode: YogaNode, margin: number | 'auto' | `${number}%` | undefined) {
  ...
  paddingBottom(yogaNode: YogaNode, padding: number | `${number}%` | undefined) {
  ...
  marginBlockEnd(yogaNode: YogaNode, margin: number | `${number}%` | undefined) {
    yogaNode.setMargin(Edge.Bottom, margin);
  },
  marginBlockStart(yogaNode: YogaNode, margin: number | `${number}%` | undefined) {
    yogaNode.setMargin(Edge.Top, margin);
  },
  paddingBlock(yogaNode: YogaNode, padding: number | `${number}%` | undefined) {
    yogaNode.setPadding(Edge.Vertical, padding);
  },
  paddingBlockEnd(yogaNode: YogaNode, padding: number | `${number}%` | undefined) {
    yogaNode.setPadding(Edge.Bottom, padding);
  },
  paddingBlockStart(yogaNode: YogaNode, padding: number | `${number}%` | undefined) {
    yogaNode.setPadding(Edge.Top, padding);
  },
  paddingHorizontal(yogaNode: YogaNode, padding: number | `${number}%` | undefined) {
    yogaNode.setPadding(Edge.Horizontal, padding);
  },
  paddingVertical(yogaNode: YogaNode, padding: number | `${number}%` | undefined) {
    yogaNode.setPadding(Edge.Vertical, padding);
  },
  marginVertical(yogaNode: YogaNode, margin: number | `${number}%` | undefined) {
    yogaNode.setMargin(Edge.Vertical, margin);
  },
  marginHorizontal(yogaNode: YogaNode, margin: number | `${number}%` | undefined) {
